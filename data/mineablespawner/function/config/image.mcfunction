function mineablespawner:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    "Mineable Spawner",\
    {text: "Mine spawners with a pickaxe", color: "#aaaaaa"},\
    "",\
    [{text: "Datapack version: ", color: "#00a800"}, {text: "v.2.1.1", color: "#54fc54"}],\
