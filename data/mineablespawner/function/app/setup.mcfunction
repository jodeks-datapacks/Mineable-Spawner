...
execute as @a unless score &break_spawner config.mineablespawner = &break_spawner config.mineablespawner run scoreboard players set &break_spawner config.mineablespawner 1

execute as @a unless score &spawn_egg_drop config.mineablespawner = &spawn_egg_drop config.mineablespawner run scoreboard players set &spawn_egg_drop config.mineablespawner 0
